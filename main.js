...
var app = (function() {
  ...
  function Nt(t) {
    ...
    return {
      c() {
        (n = w("div")),
        (n.innerHTML =
          '<p class="mb-3">A clone of <a href="https://www.heardle.app/" title="Heardle">Heardle</a> but for Trisha Yearwood songs. Each song is randomly chosen from her discography.</p> \n\n<p class="mb-3">Made by <a href="https://twitter.com/MelisMcDaniel">@MelisMcDaniel</a>. All copyright goes to Trisha Yearwood and other relevant parties.</p> \n\n\n\n <p class="mb-3">  </p>  \n\n\n\n <p class="text-xs mb-3 text-custom-line">Prepared with <a href="https://developers.soundcloud.com">SoundCloud</a>\n and powered by <a href="https://glitch.com/">Glitch</a>. See the source code <a href="https://glitch.com/edit/#!/ty-heardle">here</a>.'),
        M(n, "class", "text");
      },
      m(e, t) {
        g(e, n, t);
  ...
  function It(t) {
    ...
    return {
      c() {
        ...
        (r = w("a")),
        (r.innerHTML =
          '<span class="kofitext svelte-1d3p4dy"><class="kofiimg mr-2 mb-1 svelte-1d3p4dy"/></span><svg xmlns="http://www.w3.org/2000/svg" class="ml-2" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h13M12 5l7 7-7 7"></path></svg>'),
        M(
            r,
            "class",
  ...
  const Vt = {
    ...
    Jt = ["Better luck next time", "Wow! You really know your TY songs!", "Impressive!", "Amazing!", "Way to go!", "You got it!", "Phew! You got it!"];
      ...
      (O = new Rt({})), {
        c() {
          ...
          W.c(),
            ...
            (m = w("div")),
            (k = w("div")),
            (k.textContent = "Next Trisha Yearwood song in:"),
            (b = x()),
            Q(S.$$.fragment),
            (D = x()),
            (T = w("div")),
  ...
  function an(e) {
    ...
    return {
      c() {
        (t = _("You got today's TY Heardle within the first ")),
        (n = _(s)),
        (r = _(" seconds."));
      },
      m(e, s) {
  ...
  function ln(e) {
    ...
    return {
      c() {
        (t = _("You got today's TY Heardle within ")),
        (n = _(o)),
        (r = _("\n                second")),
        (s = _(a)),
        (i = _("."));
  ...
  function un(t) {
    ...
    return {
      c() {
        n = _("You didn't get today's TY Heardle. Better luck tomorrow!");
      },
      m(e, t) {
        g(e, n, t);
      },
  ...
  const Cn = ue([
      ...
      "Trisha Yearwood - Mr. Radio",
      "Trisha Yearwood - Pistol",
      "Trisha Yearwood - Try Me Again",
      "Trisha Yearwood - All The Way",
      "Trisha Yearwood - Too Bad You're No Good",
      "Trisha Yearwood - The Lady Is a Tramp",
      "Trisha Yearwood - Bible and a .44 (feat. Patty Loveless)",
      "Trisha Yearwood - An Angel Gets Its Wings",
      "Trisha Yearwood - You Say You Will",
      "Trisha Yearwood - Baby Don't You Let Go",
      "Trisha Yearwood - When We Were Still In Love",
      ...
      "Trisha Yearwood - When Lonely Calls",
      "Trisha Yearwood - Drinking Again",
      "Trisha Yearwood - Melancholy Blue",
      "Trisha Yearwood - Love Me Or Leave Me Alone",
      "Trisha Yearwood - Believe Me Baby (I Lied)",
      "Trisha Yearwood - Love You Anyway (feat. Don Henley)",
      "Trisha Yearwood - I'll Still Love You More",
      "Trisha Yearwood - Forever's As Far As I'll Go",
      "Trisha Yearwood - I Did",
      "Trisha Yearwood - The Whisper Of Your Heart",
      "Trisha Yearwood - For Reasons I've Forgotten",
      "Trisha Yearwood - Nothin' About You is Good For Me",
      "Trisha Yearwood - They All Laughed",
      "Trisha Yearwood - Wild For You Baby",
      "Trisha Yearwood - The Song Remembers When",
      "Trisha Yearwood - I'm Still Alive (You're Gone)",
      "Trisha Yearwood - Witchcraft",
      "Trisha Yearwood - You're Where I Belong",
      "Trisha Yearwood - Under The Rainbow",
      "Trisha Yearwood - I Need You",
      "Trisha Yearwood - Heart Like A Sad Song",
      "Trisha Yearwood - Coming Back To You",
      "Trisha Yearwood - Met Him In A Motel Room",
      "Trisha Yearwood - Hard Promises To Keep",
      "Trisha Yearwood - Hands",
      "Trisha Yearwood - Sad Eyes",
      "Trisha Yearwood - Tell Me Something I Don't Know (feat. Kelly Clarkson)",
      "Trisha Yearwood - The Nightingale",
      "Trisha Yearwood - Bring Me All Your Lovin'",
      "Trisha Yearwood - I Won't Give Up",
      "Trisha Yearwood - Georgia Rain",
      "Trisha Yearwood - We Tried",
      "Trisha Yearwood - The Woman Before Me",
      "Trisha Yearwood - Nothin' To Lose",
      "Trisha Yearwood - Like We Never Had A Broken Heart",
      "Trisha Yearwood - Follow The Wind",
      "Trisha Yearwood - End Of The World",
      "Trisha Yearwood - Try Me",
      "Trisha Yearwood - Walkaway Joe",
      "Trisha Yearwood - I Don't Fall In Love So Easy",
      "Trisha Yearwood - Come Back When It Ain't Rainin'",
      "Trisha Yearwood - Powerful Thing",
      "Trisha Yearwood - Something Kinda Like It",
      "Trisha Yearwood - It's Alright (Jasper County Album Version)",
      "Trisha Yearwood - Inside Out (feat. Don Henley)",
      "Trisha Yearwood - It's Alright (Everybody Knows Album Version)",
      "Trisha Yearwood - That's What I Like About You",
      "Trisha Yearwood - Lonesome Dove",
      "Trisha Yearwood - Standing Out In A Crowd",
      "Trisha Yearwood - Hello, I'm Gone",
      "Trisha Yearwood - Oh Lonesome You",
      "Trisha Yearwood - Come Fly With Me",
      "Trisha Yearwood - Sweet Love",
      "Trisha Yearwood - You Don't Have To Move That Mountain",
      "Trisha Yearwood - For A While",
      "Trisha Yearwood - Find A Way",
      "Trisha Yearwood - The Restless Kind",
      "Trisha Yearwood - Let The Wind Chase You (feat. Keith Urban)",
      "Trisha Yearwood - Not A Bad Thing",
      "Trisha Yearwood - Trying To Love You",
      "Trisha Yearwood - Seven Year Ache (feat. Rosanne Cash)",
      "Trisha Yearwood - What Gave Me Away (feat. Garth Brooks)",
      "Trisha Yearwood - Woman Walk The Line",
      "Trisha Yearwood - Just A Cup Of Coffee",
      ...
      "Trisha Yearwood - You Done Me Wrong (And That Ain't Right)",
      "Trisha Yearwood - Fools Like Me",
      "Trisha Yearwood - On A Bus To St. Cloud",
      "Trisha Yearwood - When A Love Song Sings The Blues",
      "Trisha Yearwood - Home",
      "Trisha Yearwood - Santa Claus Is Back In Town",
      "Trisha Yearwood - Sweet Little Jesus Boy",
      "Trisha Yearwood - I'll Be Home For Christmas",
      "Trisha Yearwood - The Christmas Song (Chestnuts Roasting On An Open Fire)",
      "Trisha Yearwood - It Wasn't His Child",
      "Trisha Yearwood - Take A Walk Through Bethlehem",
      "Trisha Yearwood - Away In A Manger",
      "Trisha Yearwood - Let It Snow! Let It Snow! Let It Snow!",
      "Trisha Yearwood - Reindeer Boogie",
      "Trisha Yearwood - Have Yourself A Merry Little Christmas",
    ...
    On = {
      subscribe: ue(
        [{
          ...
          {
            url: "https://soundcloud.com/trishayearwood/baby-dont-you-let-go-album",
            answer: "Trisha Yearwood - Baby Don't You Let Go",
          },
          {
          ...
          {
            url: "https://soundcloud.com/trishayearwood/sing-you-back-to-me",
            answer: "Trisha Yearwood - Sing You Back To Me",
          },
          {
            url: "https://soundcloud.com/trishayearwood/every-girl-in-this-town",
            answer: "Trisha Yearwood - Every Girl In This Town",
          },
          {
          ...
          {
            url: "https://soundcloud.com/trishayearwood/nothin-bout-memphis",
            answer: "Trisha Yearwood - Nothin' 'Bout Memphis",
          },
          {
          ...
          {
            url: "https://soundcloud.com/trishayearwood/the-matador",
            answer: "Trisha Yearwood - The Matador",
          },
          {
          ...
          {
            url: "https://soundcloud.com/trishayearwood/there-goes-my-baby-album",
            answer: "Trisha Yearwood - There Goes My Baby",
          },
          {
          ...
          {
            url: "https://soundcloud.com/trishayearwood/cowboys-are-my-weakness",
            answer: "Trisha Yearwood - Cowboys Are My Weakness",
          },
          {
          ...
          {
            url: "https://soundcloud.com/trishayearwood/shes-in-love-with-the-boy",
            answer: "Trisha Yearwood - She's In Love With The Boy",
          },
          {
          ...
          {
            url: "https://soundcloud.com/trishayearwood/broken",
            answer: "Trisha Yearwood - Broken",
          },
          {
            url: "https://soundcloud.com/trishayearwood/here-comes-temptation-album",
            answer: "Trisha Yearwood - Here Comes Temptation",
          },
          {
          ...
          {
            url: "https://soundcloud.com/trishayearwood/down-on-my-knees-album-version",
            answer: "Trisha Yearwood - Down On My Knees",
          },
          {
          ...
          {
            url: "https://soundcloud.com/trishayearwood/i-dont-want-to-be-the-one",
            answer: "Trisha Yearwood - I Don't Want To Be The One",
          },
          {
          ...
          {
            url: "https://soundcloud.com/trishayearwood/river-of-you-album-version",
            answer: "Trisha Yearwood - River Of You",
          },
          {
          ...
          {
            url: "https://soundcloud.com/trishayearwood/those-words-we-said-album",
            answer: "Trisha Yearwood - Those Words We Said",
          },
          {
            url: "https://soundcloud.com/trishayearwood/better-your-heart-than-mine",
            answer: "Trisha Yearwood - Better Your Heart Than Mine",
          },
          {
          ...
          {
            url: "https://soundcloud.com/trishayearwood/when-goodbye-was-a-word",
            answer: "Trisha Yearwood - When Goodbye Was A Word",
          },
          {
          ...
          {
            url: "https://soundcloud.com/trishayearwood/i-did",
            answer: "Trisha Yearwood - I Did",
          },
          {
          ...
          {
            url: "https://soundcloud.com/trishayearwood/wild-for-you-baby",
            answer: "Trisha Yearwood - Wild For You Baby",
          },
          {
          ...
          {
            url: "https://soundcloud.com/trishayearwood/tell-me-something-i-dont-know",
            answer: "Trisha Yearwood - Tell Me Something I Don't Know (feat. Kelly Clarkson)",
          },
          {
          ...
          {
            url: "https://soundcloud.com/trishayearwood/try-me-album-version",
            answer: "Trisha Yearwood - Try Me",
          },
          {
          ...
          {
            url: "https://soundcloud.com/trishayearwood/just-a-cup-of-coffee",
            answer: "Trisha Yearwood - Just A Cup Of Coffee",
          },
          {
          ...
          {
            url: "https://soundcloud.com/trishayearwood/who-invented-the-wheel-album",
            answer: "Trisha Yearwood - Who Invented The Wheel",
          },
          {
          ...
          {
            url: "https://soundcloud.com/trishayearwood/wouldnt-any-woman",
            answer: "Trisha Yearwood - Wouldn't Any Woman",
          },
          {
            url: "https://soundcloud.com/trishayearwood/they-call-it-falling-for-a",
            answer: "Trisha Yearwood - They Call It Falling For A Reason",
          },
          {
          ...
          {
            url: "https://soundcloud.com/trishayearwood/i-dont-paint-myself-into",
            answer: "Trisha Yearwood - I Don't Paint Myself Into Corners",
          },
          {
          ...
          {
            url: "https://soundcloud.com/trishayearwood/when-a-love-song-sings-the",
            answer: "Trisha Yearwood - When A Love Song Sings The Blues",
          },
          {
          ...
          {
            url: "https://soundcloud.com/trishayearwood/santa-claus-is-back-in-town",
            answer: "Trisha Yearwood - Santa Claus Is Back In Town",
          },
          {
            url: "https://soundcloud.com/trishayearwood/sweet-little-jesus-boy",
            answer: "Trisha Yearwood - Sweet Little Jesus Boy",
          },
          {
            url: "https://soundcloud.com/trishayearwood/ill-be-home-for-christmas",
            answer: "Trisha Yearwood - I'll Be Home For Christmas",
          },
          {
            url: "https://soundcloud.com/trishayearwood/the-christmas-song-chestnuts",
            answer: "Trisha Yearwood - The Christmas Song (Chestnuts Roasting On An Open Fire)",
          },
          {
            url: "https://soundcloud.com/trishayearwood/it-wasnt-his-child",
            answer: "Trisha Yearwood - It Wasn't His Child",
          },
          {
            url: "https://soundcloud.com/trishayearwood/take-a-walk-through-bethlehem",
            answer: "Trisha Yearwood - Take A Walk Through Bethlehem",
          },
          {
            url: "https://soundcloud.com/trishayearwood/away-in-a-manger",
            answer: "Trisha Yearwood - Away In A Manger",
          },
          {
            url: "https://soundcloud.com/trishayearwood/an-angel-gets-its-wings",
            answer: "Trisha Yearwood - An Angel Gets Its Wings",
          ...
          {
            url: "https://soundcloud.com/trishayearwood/let-it-snow-let-it-snow-let-it",
            answer: "Trisha Yearwood - Let It Snow! Let It Snow! Let It Snow!",
          },
          {
            url: "https://soundcloud.com/trishayearwood/reindeer-boogie",
            answer: "Trisha Yearwood - Reindeer Boogie",
          },
          {
            url: "https://soundcloud.com/trishayearwood/have-yourself-a-merry-little",
            answer: "Trisha Yearwood - Have Yourself A Merry Little Christmas",
          },
          {
            url: "https://soundcloud.com/trishayearwood/you-say-you-will-album-version",
            answer: "Trisha Yearwood - You Say You Will",
      ...
      c() {
        ...
        Q(l.$$.fragment),
          ...
          M(
            t,
            "content",
            "Guess the Trisha Yearwood song from the intro in as few tries as possible"
          ),
